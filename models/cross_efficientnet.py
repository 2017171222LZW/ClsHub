...
from models.development import CrossConv2dNormActivation as Conv2dNormActivation
# from models.development import RepConv2dNormActivation as Conv2dNormActivation
...
if __name__ == '__main__':
    ...
    model = efficientnet_b0(pretrained=False, num_classes=100)
    out = model(data)
    print(out.shape)