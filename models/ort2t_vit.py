...
# All rights reserved.
# https://github.com/yitu-opensource/T2T-ViT.git
"""
T2T-ViT
"""
import torch
...
from models.transformer_block import get_sinusoid_encoding
...
@register_model
def ort2t_vit_7(pretrained=False, **kwargs):  # adopt performer for tokens to token
    if pretrained:
...
@register_model
def ort2t_vit_10(pretrained=False, **kwargs):  # adopt performer for tokens to token
    if pretrained:
        kwargs.setdefault('qk_scale', 256 ** -0.5)
...
@register_model
def ort2t_vit_12(pretrained=False, **kwargs):  # adopt performer for tokens to token
    if pretrained:
        kwargs.setdefault('qk_scale', 256 ** -0.5)
...
@register_model
def ort2t_vit_14(pretrained=False, **kwargs):  # adopt performer for tokens to token
    if pretrained:
...
@register_model
def ort2t_vit_19(pretrained=False, **kwargs):  # adopt performer for tokens to token
    if pretrained:
...
@register_model
def ort2t_vit_24(pretrained=False, **kwargs):  # adopt performer for tokens to token
    if pretrained:
...
@register_model
def ort2t_vit_t_14(pretrained=False, **kwargs):  # adopt transformers for tokens to token
    if pretrained:
        kwargs.setdefault('qk_scale', 384 ** -0.5)
...
@register_model
def ort2t_vit_t_19(pretrained=False, **kwargs):  # adopt transformers for tokens to token
    if pretrained:
        kwargs.setdefault('qk_scale', 448 ** -0.5)
...
@register_model
def ort2t_vit_t_24(pretrained=False, **kwargs):  # adopt transformers for tokens to token
    if pretrained:
        kwargs.setdefault('qk_scale', 512 ** -0.5)
...
@register_model
def ort2t_vit_14_resnext(pretrained=False, **kwargs):
    if pretrained:
        kwargs.setdefault('qk_scale', 384 ** -0.5)
...
@register_model
def ort2t_vit_14_wide(pretrained=False, **kwargs):
    if pretrained:
        kwargs.setdefault('qk_scale', 512 ** -0.5)
...
if __name__ == '__main__':
    ...
    model = ort2t_vit_14(pretrained=False, num_classes=100)
    out = model(data)
    print(out.shape)
