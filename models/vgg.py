...
def _vgg(cfg: str, batch_norm: bool, weights: Optional[WeightsEnum], progress: bool, num_classes=1000, **kwargs: Any):
...
@register_model
def vgg11(*, pretrained=False, progress: bool = True, **kwargs: Any):
    if pretrained:
        weights = VGG11_Weights.verify(VGG11_Weights.IMAGENET1K_V1)
    else:
        weights = VGG11_Weights.verify(None)

    return _vgg("A", False, weights, progress, **kwargs)


@register_model
def vgg11_bn(*, pretrained=False, progress: bool = True, **kwargs: Any):
    if pretrained:
        weights = VGG11_BN_Weights.verify(VGG11_BN_Weights.IMAGENET1K_V1)
    else:
        weights = VGG11_BN_Weights.verify(None)

    return _vgg("A", True, weights, progress, **kwargs)


@register_model
def vgg13(*, pretrained=False, progress: bool = True, **kwargs: Any):
    if pretrained:
        weights = VGG13_Weights.verify(VGG13_Weights.IMAGENET1K_V1)
    else:
        weights = VGG13_Weights.verify(None)

    return _vgg("B", False, weights, progress, **kwargs)


@register_model
def vgg13_bn(*, pretrained=False, progress: bool = True, **kwargs: Any):
    if pretrained:
        weights = VGG13_BN_Weights.verify(VGG13_BN_Weights.IMAGENET1K_V1)
    else:
        weights = VGG13_BN_Weights.verify(None)

    return _vgg("B", True, weights, progress, **kwargs)


@register_model
def vgg16(*, pretrained=False, progress: bool = True, **kwargs: Any):
    if pretrained:
        weights = VGG16_Weights.verify(VGG16_Weights.IMAGENET1K_V1)
    else:
        weights = VGG16_Weights.verify(None)

    return _vgg("D", False, weights, progress, **kwargs)


@register_model
def vgg16_bn(*, pretrained=False, progress: bool = True, **kwargs: Any):
    if pretrained:
        weights = VGG16_BN_Weights.verify(VGG16_BN_Weights.IMAGENET1K_V1)
    else:
        weights = VGG16_BN_Weights.verify(None)

    return _vgg("D", True, weights, progress, **kwargs)


@register_model
def vgg19(*, pretrained=False, progress: bool = True, **kwargs: Any):
    if pretrained:
        weights = VGG19_Weights.verify(VGG19_Weights.IMAGENET1K_V1)
    else:
        weights = VGG19_Weights.verify(None)

    return _vgg("E", False, weights, progress, **kwargs)


@register_model
def vgg19_bn(*, pretrained=False, progress: bool = True, **kwargs: Any):
    if pretrained:
        weights = VGG19_BN_Weights.verify(VGG19_BN_Weights.IMAGENET1K_V1)
    else:
        weights = VGG19_BN_Weights.verify(None)
...
if __name__ == '__main__':
    ...
    model = vgg11(pretrained=True, num_classes=100)
    out = model(data)
    print(out.shape)
