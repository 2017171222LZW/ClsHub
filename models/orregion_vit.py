...
# https://github.com/IBM/RegionViT.git
...
from models.attention_variants import OneRegularAttentionWithRelPos as AttentionWithRelPos
from models.attention2d import LayerNorm2d
...
if __name__ == '__main__':
    ...
    model = regionvit_base_w14_peg_224(pretrained=False, num_classes=100)
    out = model(data)
    print(out.shape)