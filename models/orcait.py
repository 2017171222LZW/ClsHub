...
class Class_Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        # unitization
        # q_m = 1.0 / torch.sqrt(torch.sum(torch.pow(q, 2), dim=-1)).unsqueeze(-1)
        # q = q * q_m
        # k_m = 1.0 / torch.sqrt(torch.sum(torch.pow(k, 2), dim=-1)).unsqueeze(-1)
        # k = k * k_m
        q = q / torch.max(q)
...
@register_model
def cait_XXS24_224(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
@register_model
def cait_XXS24(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
@register_model
def cait_XXS36_224(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
@register_model
def cait_XXS36(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
@register_model
def cait_XS24(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
@register_model
def cait_S24_224(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
@register_model
def cait_S24(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
@register_model
def cait_S36(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
@register_model
def cait_M36(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
@register_model
def cait_M48(pretrained=False, num_classes=1000, **kwargs):
    model = cait_models(
...
if __name__ == '__main__':
    ...
    model = cait_XXS24_224(pretrained=True, num_classes=100)
    out = model(data)
    print(out.shape)