...
from timm.models import build_model_with_cfg, register_notrace_function, named_apply, checkpoint_seq, register_model, \
...
from models.convit_ga_modules import CbamModule
...
class MaxxVitCfg:
    ...
    block_type: Tuple[Union[str, Tuple[str, ...]], ...] = ('C', 'T', 'C', 'T')
...
class MbConvBlock(nn.Module):
    ...
    def __init__(
        ...
        if cfg.attn_early:
            ...
            self.se_early = None
            self.norm2 = norm_act_layer(mid_chs)
            if cfg.attn_layer == 'cbam':
                self.se = CbamModule(mid_chs, **attn_kwargs)
            else:
...
class SelfAttention2D(nn.Module):
    def __init__(self, in_ch, out_ch, emb_dim=16, patch_size=32):
        super(SelfAttention2D, self).__init__()
        # self.extend = nn.Conv2d(emb_dim, emb_dim * 3, kernel_size=1)
        self.patch_size = patch_size
        self.split = Rearrange('n (s e) (m1 p1) (m2 p2) -> s n e m1 m2 p1 p2', s=3, p1=self.patch_size, p2=self.patch_size)
        self.to_qkv = GhostBottleneck(in_ch, emb_dim, 3 * emb_dim)
        self.restore = Rearrange('n e m1 m2 p1 p2 -> n e (m1 p1) (m2 p2)')
        self.split2 = Rearrange('n e (m1 p1) (m2 p2) -> n e m1 m2 p1 p2', p1=self.patch_size, p2=self.patch_size)
    ...
    def forward(self, x):
        ...
        x = self.split(x)
        q = x[0]
        k = x[1].permute(0, 1, 2, 3, 5, 4)
        v = x[2]
        attn = q @ k / math.sqrt(self.patch_size)
        attn = self.restore(attn)
        attn = self.sm(attn)
        attn = self.split2(attn)
        x = v @ attn
        x = self.restore(x)
        x = self.squeeze(x)
        return x
...
class Stem(nn.Module):
    ...
    def __init__(
        ...
        self.attn2d = SelfAttention2D(out_chs[0], out_chs[0], 64, 16)
...
model_cfgs = dict(
    ...
    convit_v2_1_rw=MaxxVitCfg(
        embed_dim=(96, 129, 192, 512),
        depths=(2, 4, 9, 4),
        stem_width=(32, 64),
        **_rw_coat_cfg(
            stride_mode='dw',
    ...
    convit_v2_2_rw=MaxxVitCfg(
        embed_dim=(128, 192, 256, 512),
        depths=(2, 5, 10, 3),
        stem_width=(64, 128),
        **_rw_coat_cfg(
            stride_mode='dw',
    ...
    convit_v2_3_rw=MaxxVitCfg(
        embed_dim=(192, 256, 512, 768),
        depths=(2, 6, 12, 3),
        stem_width=(96, 192),
        **_rw_coat_cfg(
            stride_mode='dw',
    ...
    convit_v2_rmlp_nano_rw=MaxxVitCfg(
        embed_dim=(64, 128, 256, 512),
        depths=(3, 4, 6, 3),
        stem_width=(32, 64),
        **_rw_max_cfg(
    ...
    convit_v2_rmlp_0_rw=MaxxVitCfg(
        embed_dim=(96, 192, 384, 768),
        depths=(2, 3, 7, 2),  # deeper than paper '0' model
        stem_width=(32, 64),
        **_rw_coat_cfg(
    ...
    convit_v2_rmlp_1_rw=MaxxVitCfg(
        embed_dim=(96, 192, 384, 768),
        depths=(2, 6, 14, 2),
        stem_width=(32, 64),
        **_rw_coat_cfg(
    ...
    convit_v2_rmlp_1_rw2=MaxxVitCfg(
        embed_dim=(96, 192, 384, 768),
        depths=(2, 6, 14, 2),
        stem_width=(32, 64),
        **_rw_coat_cfg(
    ...
    convit_v2_rmlp_2_rw=MaxxVitCfg(
    ...
    convit_v2_rmlp_3_rw=MaxxVitCfg(
    ...
    convit_v2_0=MaxxVitCfg(
        embed_dim=(96, 192, 384, 768),
        depths=(2, 3, 5, 2),
        stem_width=64,
        head_hidden_size=768,
    ),
    convit_v2_1=MaxxVitCfg(
        embed_dim=(96, 192, 384, 768),
        depths=(2, 6, 14, 2),
        stem_width=64,
        head_hidden_size=768,
    ),
    convit_v2_2=MaxxVitCfg(
        embed_dim=(128, 256, 512, 1024),
        depths=(2, 6, 14, 2),
        stem_width=128,
        head_hidden_size=1024,
    ),
    convit_v2_3=MaxxVitCfg(
        embed_dim=(192, 384, 768, 1536),
        depths=(2, 6, 14, 2),
        stem_width=192,
        head_hidden_size=1536,
    ),
    convit_v2_4=MaxxVitCfg(
        embed_dim=(192, 384, 768, 1536),
        depths=(2, 12, 28, 2),
        stem_width=192,
        head_hidden_size=1536,
    ),
    convit_v2_5=MaxxVitCfg(
...
default_cfgs = generate_default_cfgs({
    ...
    'convit_v2_pico_rw_224.untrained': _cfg(url=''),
    'convit_v2_nano_rw_224.sw_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights-maxx/convit_v2_nano_rw_224_sw-f53093b4.pth',
        crop_pct=0.9),
    'convit_v2_0_rw_224.sw_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights-maxx/convit_v2_0_rw_224_sw-a6439706.pth'),
    'convit_v2_1_rw_224.sw_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights-maxx/convit_v2_1_rw_224_sw-5cae1ea8.pth'
    ),

    # timm specific CoAtNet configs, ImageNet-12k pretrain w/ 1k fine-tune, fixed rel-pos
    'convit_v2_2_rw_224.sw_in12k_ft_in1k': _cfg(
        hf_hub_id='timm/'),
    # 'convit_v2_3_rw_224.untrained': _cfg(url=''),

    # Experimental CoAtNet configs w/ ImageNet-12k pretrain -> 1k fine-tune (different norm layers, MLP rel-pos)
    'convit_v2_rmlp_1_rw2_224.sw_in12k_ft_in1k': _cfg(
        hf_hub_id='timm/'),
    'convit_v2_rmlp_2_rw_224.sw_in12k_ft_in1k': _cfg(
        hf_hub_id='timm/'),
    'convit_v2_rmlp_2_rw_384.sw_in12k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),

    # Experimental CoAtNet configs w/ ImageNet-1k train (different norm layers, MLP rel-pos)
    'convit_v2_bn_0_rw_224.sw_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights-maxx/convit_v2_bn_0_rw_224_sw-c228e218.pth',
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD,
        crop_pct=0.95),
    'convit_v2_rmlp_nano_rw_224.sw_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights-maxx/convit_v2_rmlp_nano_rw_224_sw-bd1d51b3.pth',
        crop_pct=0.9),
    'convit_v2_rmlp_0_rw_224.untrained': _cfg(url=''),
    'convit_v2_rmlp_1_rw_224.sw_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights-maxx/convit_v2_rmlp_1_rw_224_sw-9051e6c3.pth'),
    'convit_v2_rmlp_2_rw_224.sw_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights-maxx/convit_v2_rmlp_2_rw_224_sw-5ccfac55.pth'),
    'convit_v2_rmlp_3_rw_224.untrained': _cfg(url=''),
    'convit_v2_nano_cc_224.untrained': _cfg(url=''),
    ...
    'convit_v2_2_rw_224.sw_in12k': _cfg(
        hf_hub_id='timm/',
        num_classes=11821),
    'convit_v2_3_rw_224.sw_in12k': _cfg(
        hf_hub_id='timm/',
        num_classes=11821),
    'convit_v2_rmlp_1_rw2_224.sw_in12k': _cfg(
        hf_hub_id='timm/',
        num_classes=11821),
    'convit_v2_rmlp_2_rw_224.sw_in12k': _cfg(
        hf_hub_id='timm/',
        num_classes=11821),

    # Trying to be like the CoAtNet paper configs (will adapt if 'tf' weights are ever released)
    'convit_v2_0_224.untrained': _cfg(url=''),
    'convit_v2_1_224.untrained': _cfg(url=''),
    'convit_v2_2_224.untrained': _cfg(url=''),
    'convit_v2_3_224.untrained': _cfg(url=''),
    'convit_v2_4_224.untrained': _cfg(url=''),
    'convit_v2_5_224.untrained': _cfg(url=''),
})


@register_model
def convit_v2_pico_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_pico_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_nano_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_nano_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_0_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_0_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_1_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_1_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_2_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_2_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_3_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_3_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_bn_0_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_bn_0_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_rmlp_nano_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_rmlp_nano_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_rmlp_0_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_rmlp_0_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_rmlp_1_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_rmlp_1_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_rmlp_1_rw2_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_rmlp_1_rw2_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_rmlp_2_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_rmlp_2_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_rmlp_2_rw_384(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_rmlp_2_rw_384', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_rmlp_3_rw_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_rmlp_3_rw_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_nano_cc_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_nano_cc_224', pretrained=pretrained, **kwargs)
...
@register_model
def convit_v2_0_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_0_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_1_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_1_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_2_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_2_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_3_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_3_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_4_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_4_224', pretrained=pretrained, **kwargs)


@register_model
def convit_v2_5_224(pretrained=False, **kwargs) -> MaxxVit:
    return _create_maxxvit('convit_v2_5_224', pretrained=pretrained, **kwargs)


if __name__ == '__main__':
    data = torch.rand(1, 3, 224, 224)
    model = convit_v2_pico_rw_224(pretrained=False, num_classes=100)
    out = model(data)
    print(out.shape)
