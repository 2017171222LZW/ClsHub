...
@register_model
def cvt_2_4_224(pretrained=False, progress=False,
...
@register_model
def cvt_2_4_224_sine(pretrained=False, progress=False,
...
@register_model
def cvt_4_4_224(pretrained=False, progress=False,
               img_size=224, positional_embedding='learnable', num_classes=10,
               *args, **kwargs):
...
@register_model
def cvt_4_4_224_sine(pretrained=False, progress=False,
                    img_size=224, positional_embedding='sine', num_classes=10,
                    *args, **kwargs):
...
@register_model
def cvt_6_4_224(pretrained=False, progress=False,
               img_size=224, positional_embedding='learnable', num_classes=10,
               *args, **kwargs):
...
@register_model
def cvt_6_4_224_sine(pretrained=False, progress=False,
                    img_size=224, positional_embedding='sine', num_classes=10,
                    *args, **kwargs):
...
@register_model
def cvt_7_4_224(pretrained=False, progress=False,
               img_size=224, positional_embedding='learnable', num_classes=10,
               *args, **kwargs):
...
@register_model
def cvt_7_4_224_sine(pretrained=False, progress=False,
                    img_size=224, positional_embedding='sine', num_classes=10,
                    *args, **kwargs):
...
if __name__ == '__main__':
    ...
    model = cvt_2_4_224(pretrained=False, num_classes=100)
    out = model(data)
    print(out.shape)
    ...
    # model = cvt_7_4_224(pretrained=False, num_classes=100)
    # out = model(data)
    # print(out.shape)
    #
    # flops, params = profile(model, inputs=(data,), verbose=False)
